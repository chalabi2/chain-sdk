...
> = {
  $type: "akash.deployment.v1beta5.QueryDeploymentsRequest" as const,
...
> = {
  $type: "akash.deployment.v1beta5.QueryDeploymentsResponse" as const,
...
> = {
  $type: "akash.deployment.v1beta5.QueryDeploymentRequest" as const,
...
> = {
  $type: "akash.deployment.v1beta5.QueryDeploymentResponse" as const,
...
export const QueryGroupRequest: MessageFns<QueryGroupRequest, "akash.deployment.v1beta5.QueryGroupRequest"> = {
  $type: "akash.deployment.v1beta5.QueryGroupRequest" as const,
...
export const QueryGroupResponse: MessageFns<QueryGroupResponse, "akash.deployment.v1beta5.QueryGroupResponse"> = {
  $type: "akash.deployment.v1beta5.QueryGroupResponse" as const,
...
export const QueryParamsRequest: MessageFns<QueryParamsRequest, "akash.deployment.v1beta5.QueryParamsRequest"> = {
  $type: "akash.deployment.v1beta5.QueryParamsRequest" as const,
...
export const QueryParamsResponse: MessageFns<QueryParamsResponse, "akash.deployment.v1beta5.QueryParamsResponse"> = {
  $type: "akash.deployment.v1beta5.QueryParamsResponse" as const,
