...
export const MsgCloseGroup: MessageFns<MsgCloseGroup, "akash.deployment.v1beta5.MsgCloseGroup"> = {
  $type: "akash.deployment.v1beta5.MsgCloseGroup" as const,
...
> = {
  $type: "akash.deployment.v1beta5.MsgCloseGroupResponse" as const,
...
export const MsgPauseGroup: MessageFns<MsgPauseGroup, "akash.deployment.v1beta5.MsgPauseGroup"> = {
  $type: "akash.deployment.v1beta5.MsgPauseGroup" as const,
...
> = {
  $type: "akash.deployment.v1beta5.MsgPauseGroupResponse" as const,
...
export const MsgStartGroup: MessageFns<MsgStartGroup, "akash.deployment.v1beta5.MsgStartGroup"> = {
  $type: "akash.deployment.v1beta5.MsgStartGroup" as const,
...
> = {
  $type: "akash.deployment.v1beta5.MsgStartGroupResponse" as const,
