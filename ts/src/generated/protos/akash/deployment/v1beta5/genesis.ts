...
export const GenesisDeployment: MessageFns<GenesisDeployment, "akash.deployment.v1beta5.GenesisDeployment"> = {
  $type: "akash.deployment.v1beta5.GenesisDeployment" as const,
...
export const GenesisState: MessageFns<GenesisState, "akash.deployment.v1beta5.GenesisState"> = {
  $type: "akash.deployment.v1beta5.GenesisState" as const,
