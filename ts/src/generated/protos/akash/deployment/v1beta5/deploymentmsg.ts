...
export const MsgCreateDeployment: MessageFns<MsgCreateDeployment, "akash.deployment.v1beta5.MsgCreateDeployment"> = {
  $type: "akash.deployment.v1beta5.MsgCreateDeployment" as const,
...
> = {
  $type: "akash.deployment.v1beta5.MsgCreateDeploymentResponse" as const,
...
export const MsgUpdateDeployment: MessageFns<MsgUpdateDeployment, "akash.deployment.v1beta5.MsgUpdateDeployment"> = {
  $type: "akash.deployment.v1beta5.MsgUpdateDeployment" as const,
...
> = {
  $type: "akash.deployment.v1beta5.MsgUpdateDeploymentResponse" as const,
...
export const MsgCloseDeployment: MessageFns<MsgCloseDeployment, "akash.deployment.v1beta5.MsgCloseDeployment"> = {
  $type: "akash.deployment.v1beta5.MsgCloseDeployment" as const,
...
> = {
  $type: "akash.deployment.v1beta5.MsgCloseDeploymentResponse" as const,
