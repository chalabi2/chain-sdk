...
function createBaseStorageParams(): StorageParams {
  return { name: "", mount: "", readOnly: false, volume: "" };
}

export const StorageParams: MessageFns<StorageParams, "akash.manifest.v2beta4.StorageParams"> = {
  $type: "akash.manifest.v2beta4.StorageParams" as const,
...
export const ServicePermissions: MessageFns<ServicePermissions, "akash.manifest.v2beta4.ServicePermissions"> = {
  $type: "akash.manifest.v2beta4.ServicePermissions" as const,
...
export const TEEParams: MessageFns<TEEParams, "akash.manifest.v2beta4.TEEParams"> = {
  $type: "akash.manifest.v2beta4.TEEParams" as const,
...
export const ServiceParams: MessageFns<ServiceParams, "akash.manifest.v2beta4.ServiceParams"> = {
  $type: "akash.manifest.v2beta4.ServiceParams" as const,
...
export const ImageCredentials: MessageFns<ImageCredentials, "akash.manifest.v2beta4.ImageCredentials"> = {
  $type: "akash.manifest.v2beta4.ImageCredentials" as const,
...
export const Service: MessageFns<Service, "akash.manifest.v2beta4.Service"> = {
  $type: "akash.manifest.v2beta4.Service" as const,
