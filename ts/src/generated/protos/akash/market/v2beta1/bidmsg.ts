...
export const MsgCreateBid: MessageFns<MsgCreateBid, "akash.market.v2beta1.MsgCreateBid"> = {
  $type: "akash.market.v2beta1.MsgCreateBid" as const,
...
export const MsgCreateBidResponse: MessageFns<MsgCreateBidResponse, "akash.market.v2beta1.MsgCreateBidResponse"> = {
  $type: "akash.market.v2beta1.MsgCreateBidResponse" as const,
...
export const MsgCloseBid: MessageFns<MsgCloseBid, "akash.market.v2beta1.MsgCloseBid"> = {
  $type: "akash.market.v2beta1.MsgCloseBid" as const,
...
export const MsgCloseBidResponse: MessageFns<MsgCloseBidResponse, "akash.market.v2beta1.MsgCloseBidResponse"> = {
  $type: "akash.market.v2beta1.MsgCloseBidResponse" as const,
