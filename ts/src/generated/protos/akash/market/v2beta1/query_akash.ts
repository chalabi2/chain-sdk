...
export const Query = {
  typeName: "akash.market.v2beta1.Query",
  methods: {
    orders: {
      name: "Orders",
      httpPath: "/akash/market/v2beta1/orders/list",
    ...
    order: {
      name: "Order",
      httpPath: "/akash/market/v2beta1/orders/info",
    ...
    bids: {
      name: "Bids",
      httpPath: "/akash/market/v2beta1/bids/list",
    ...
    bid: {
      name: "Bid",
      httpPath: "/akash/market/v2beta1/bids/info",
    ...
    leases: {
      name: "Leases",
      httpPath: "/akash/market/v2beta1/leases/list",
    ...
    lease: {
      name: "Lease",
      httpPath: "/akash/market/v2beta1/leases/info",
    ...
    params: {
      name: "Params",
      httpPath: "/akash/market/v2beta1/params",
