...
export const MsgCreateLease: MessageFns<MsgCreateLease, "akash.market.v2beta1.MsgCreateLease"> = {
  $type: "akash.market.v2beta1.MsgCreateLease" as const,
...
export const MsgCreateLeaseResponse: MessageFns<MsgCreateLeaseResponse, "akash.market.v2beta1.MsgCreateLeaseResponse"> =
  {
    $type: "akash.market.v2beta1.MsgCreateLeaseResponse" as const,
...
export const MsgWithdrawLease: MessageFns<MsgWithdrawLease, "akash.market.v2beta1.MsgWithdrawLease"> = {
  $type: "akash.market.v2beta1.MsgWithdrawLease" as const,
...
> = {
  $type: "akash.market.v2beta1.MsgWithdrawLeaseResponse" as const,
...
export const MsgCloseLease: MessageFns<MsgCloseLease, "akash.market.v2beta1.MsgCloseLease"> = {
  $type: "akash.market.v2beta1.MsgCloseLease" as const,
...
export const MsgCloseLeaseResponse: MessageFns<MsgCloseLeaseResponse, "akash.market.v2beta1.MsgCloseLeaseResponse"> = {
  $type: "akash.market.v2beta1.MsgCloseLeaseResponse" as const,
...
export const MsgLeaseStartReclaim: MessageFns<MsgLeaseStartReclaim, "akash.market.v2beta1.MsgLeaseStartReclaim"> = {
  $type: "akash.market.v2beta1.MsgLeaseStartReclaim" as const,
...
export const MsgLeaseStartReclaimResponse: MessageFns<
  ...
  "akash.market.v2beta1.MsgLeaseStartReclaimResponse"
> = {
  $type: "akash.market.v2beta1.MsgLeaseStartReclaimResponse" as const,
