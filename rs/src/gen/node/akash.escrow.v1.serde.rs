...
impl<'de> serde::Deserialize<'de> for DepositAuthorization {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.escrow.v1.DepositAuthorization")
            }
        ...
        deserializer.deserialize_struct("akash.escrow.v1.DepositAuthorization", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for EventAccountRunway {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        if self.projected_depletion_height != 0 {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("akash.escrow.v1.EventAccountRunway", len)?;
        ...
        if self.projected_depletion_height != 0 {
            ...
            struct_ser.serialize_field("projectedDepletionHeight", ToString::to_string(&self.projected_depletion_height).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for EventAccountRunway {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        const FIELDS: &[&str] = &[
            "id",
            "projected_depletion_height",
            "projectedDepletionHeight",
        ];
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "projectedDepletionHeight" | "projected_depletion_height" => Ok(GeneratedField::ProjectedDepletionHeight),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = EventAccountRunway;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.escrow.v1.EventAccountRunway")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<EventAccountRunway, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut id__ = None;
                let mut projected_depletion_height__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Id => {
                            if id__.is_some() {
                        ...
                        GeneratedField::ProjectedDepletionHeight => {
                            if projected_depletion_height__.is_some() {
                                return Err(serde::de::Error::duplicate_field("projectedDepletionHeight"));
                            }
                            projected_depletion_height__ = 
                                Some(map_.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0)
                            ;
                        }
                    }
                }
                Ok(EventAccountRunway {
                    id: id__,
                    projected_depletion_height: projected_depletion_height__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("akash.escrow.v1.EventAccountRunway", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GenesisState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.escrow.v1.GenesisState", len)?;
        if !self.accounts.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GenesisState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.escrow.v1.GenesisState")
            }
        ...
        deserializer.deserialize_struct("akash.escrow.v1.GenesisState", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgAccountDeposit {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.escrow.v1.MsgAccountDeposit", len)?;
        if !self.signer.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MsgAccountDeposit {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.escrow.v1.MsgAccountDeposit")
            }
        ...
        deserializer.deserialize_struct("akash.escrow.v1.MsgAccountDeposit", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgAccountDepositResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("akash.escrow.v1.MsgAccountDepositResponse", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for MsgAccountDepositResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.escrow.v1.MsgAccountDepositResponse")
            }
        ...
        deserializer.deserialize_struct("akash.escrow.v1.MsgAccountDepositResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryAccountsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.escrow.v1.QueryAccountsRequest", len)?;
        if !self.state.is_empty() {
...
impl<'de> serde::Deserialize<'de> for QueryAccountsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.escrow.v1.QueryAccountsRequest")
            }
        ...
        deserializer.deserialize_struct("akash.escrow.v1.QueryAccountsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryAccountsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.escrow.v1.QueryAccountsResponse", len)?;
        if !self.accounts.is_empty() {
            struct_ser.serialize_field("accounts", &self.accounts)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl<'de> serde::Deserialize<'de> for QueryAccountsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.escrow.v1.QueryAccountsResponse")
            }
        ...
        deserializer.deserialize_struct("akash.escrow.v1.QueryAccountsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryPaymentsRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.escrow.v1.QueryPaymentsRequest", len)?;
        if !self.state.is_empty() {
            struct_ser.serialize_field("state", &self.state)?;
        }
        if !self.xid.is_empty() {
...
impl<'de> serde::Deserialize<'de> for QueryPaymentsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.escrow.v1.QueryPaymentsRequest")
            }
        ...
        deserializer.deserialize_struct("akash.escrow.v1.QueryPaymentsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for QueryPaymentsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.escrow.v1.QueryPaymentsResponse", len)?;
        if !self.payments.is_empty() {
            struct_ser.serialize_field("payments", &self.payments)?;
        }
        if let Some(v) = self.pagination.as_ref() {
...
impl<'de> serde::Deserialize<'de> for QueryPaymentsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.escrow.v1.QueryPaymentsResponse")
            }
        ...
        deserializer.deserialize_struct("akash.escrow.v1.QueryPaymentsResponse", FIELDS, GeneratedVisitor)
    }
}
