...
impl serde::Serialize for Group {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.manifest.v2beta4.Group", len)?;
        if !self.name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Group {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.manifest.v2beta4.Group")
            }
        ...
        deserializer.deserialize_struct("akash.manifest.v2beta4.Group", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ImageCredentials {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.manifest.v2beta4.ImageCredentials", len)?;
        if !self.host.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ImageCredentials {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.manifest.v2beta4.ImageCredentials")
            }
        ...
        deserializer.deserialize_struct("akash.manifest.v2beta4.ImageCredentials", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Service {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.manifest.v2beta4.Service", len)?;
        if !self.name.is_empty() {
            struct_ser.serialize_field("name", &self.name)?;
        }
        if !self.image.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Service {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.manifest.v2beta4.Service")
            }
        ...
        deserializer.deserialize_struct("akash.manifest.v2beta4.Service", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ServiceExpose {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.manifest.v2beta4.ServiceExpose", len)?;
        if self.port != 0 {
...
impl<'de> serde::Deserialize<'de> for ServiceExpose {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.manifest.v2beta4.ServiceExpose")
            }
        ...
        deserializer.deserialize_struct("akash.manifest.v2beta4.ServiceExpose", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ServiceExposeHttpOptions {
        ...
        S: serde::Serializer,
    {
        ...
        if self.proxy_buffer_size != 0 {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("akash.manifest.v2beta4.ServiceExposeHTTPOptions", len)?;
        if self.max_body_size != 0 {
        ...
        if self.proxy_buffer_size != 0 {
            struct_ser.serialize_field("proxyBufferSize", &self.proxy_buffer_size)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for ServiceExposeHttpOptions {
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "proxyBufferSize" | "proxy_buffer_size" => Ok(GeneratedField::ProxyBufferSize),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.manifest.v2beta4.ServiceExposeHTTPOptions")
            }
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                let mut proxy_buffer_size__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::ProxyBufferSize => {
                            if proxy_buffer_size__.is_some() {
                                return Err(serde::de::Error::duplicate_field("proxyBufferSize"));
                            }
                            proxy_buffer_size__ = 
                                Some(map_.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0)
                            ;
                ...
                Ok(ServiceExposeHttpOptions {
                    ...
                    proxy_buffer_size: proxy_buffer_size__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("akash.manifest.v2beta4.ServiceExposeHTTPOptions", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ServiceParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.manifest.v2beta4.ServiceParams", len)?;
        if !self.storage.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ServiceParams {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.manifest.v2beta4.ServiceParams")
            }
        ...
        deserializer.deserialize_struct("akash.manifest.v2beta4.ServiceParams", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ServicePermissions {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.manifest.v2beta4.ServicePermissions", len)?;
        if !self.read.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ServicePermissions {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ServicePermissions;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.manifest.v2beta4.ServicePermissions")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ServicePermissions, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut read__ = None;
        ...
        deserializer.deserialize_struct("akash.manifest.v2beta4.ServicePermissions", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for StorageParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.manifest.v2beta4.StorageParams", len)?;
        if !self.name.is_empty() {
            struct_ser.serialize_field("name", &self.name)?;
        }
        if !self.mount.is_empty() {
...
impl<'de> serde::Deserialize<'de> for StorageParams {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.manifest.v2beta4.StorageParams")
            }
        ...
        deserializer.deserialize_struct("akash.manifest.v2beta4.StorageParams", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TeeParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("akash.manifest.v2beta4.TEEParams", len)?;
        if !self.r#type.is_empty() {
...
impl<'de> serde::Deserialize<'de> for TeeParams {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct akash.manifest.v2beta4.TEEParams")
            }
        ...
        deserializer.deserialize_struct("akash.manifest.v2beta4.TEEParams", FIELDS, GeneratedVisitor)
    }
}
