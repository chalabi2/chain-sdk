...
import (
	...
	v1beta4 "pkg.akt.dev/go/node/client/v1beta4"
)
...
func (_m *Client) Node() v1beta4.NodeClient {
	ret := _m.Called()
	...
	var r0 v1beta4.NodeClient
	if rf, ok := ret.Get(0).(func() v1beta4.NodeClient); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(v1beta4.NodeClient)
		}
	}
...
func (_c *Client_Node_Call) Return(_a0 v1beta4.NodeClient) *Client_Node_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Client_Node_Call) RunAndReturn(run func() v1beta4.NodeClient) *Client_Node_Call {
	_c.Call.Return(run)
	return _c
}

// PrintJSON provides a mock function with given fields: msg
func (_m *Client) PrintJSON(msg interface{}) error {
	ret := _m.Called(msg)

	if len(ret) == 0 {
		panic("no return value specified for PrintJSON")
	}
...
// Client_PrintJSON_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PrintJSON'
type Client_PrintJSON_Call struct {
	*mock.Call
}

// PrintJSON is a helper method to define mock.On call
//   - msg interface{}
func (_e *Client_Expecter) PrintJSON(msg interface{}) *Client_PrintJSON_Call {
	return &Client_PrintJSON_Call{Call: _e.mock.On("PrintJSON", msg)}
}

func (_c *Client_PrintJSON_Call) Run(run func(msg interface{})) *Client_PrintJSON_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Client_PrintJSON_Call) Return(_a0 error) *Client_PrintJSON_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Client_PrintJSON_Call) RunAndReturn(run func(interface{}) error) *Client_PrintJSON_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Client) Query() v1beta4.QueryClient {
	ret := _m.Called()
...
func (_c *Client_Query_Call) Return(_a0 v1beta4.QueryClient) *Client_Query_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Client_Query_Call) RunAndReturn(run func() v1beta4.QueryClient) *Client_Query_Call {
	_c.Call.Return(run)
	return _c
}

// Tx provides a mock function with no fields
func (_m *Client) Tx() v1beta4.TxClient {
	ret := _m.Called()
	...
	var r0 v1beta4.TxClient
	if rf, ok := ret.Get(0).(func() v1beta4.TxClient); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(v1beta4.TxClient)
		}
	}
...
func (_c *Client_Tx_Call) Return(_a0 v1beta4.TxClient) *Client_Tx_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Client_Tx_Call) RunAndReturn(run func() v1beta4.TxClient) *Client_Tx_Call {
	_c.Call.Return(run)
	return _c
}
