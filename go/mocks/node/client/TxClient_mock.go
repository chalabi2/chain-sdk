...
func (_m *TxClient) BroadcastMsgs(_a0 context.Context, _a1 []types.Msg, _a2 ...v1beta4.BroadcastOption) (interface{}, error) {
	...
	var r0 interface{}
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []types.Msg, ...v1beta4.BroadcastOption) (interface{}, error)); ok {
		return rf(_a0, _a1, _a2...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []types.Msg, ...v1beta4.BroadcastOption) interface{}); ok {
		r0 = rf(_a0, _a1, _a2...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, []types.Msg, ...v1beta4.BroadcastOption) error); ok {
		r1 = rf(_a0, _a1, _a2...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *TxClient_BroadcastMsgs_Call) Run(run func(_a0 context.Context, _a1 []types.Msg, _a2 ...v1beta4.BroadcastOption)) *TxClient_BroadcastMsgs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]v1beta4.BroadcastOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
				variadicArgs[i] = a.(v1beta4.BroadcastOption)
			}
		}
...
func (_c *TxClient_BroadcastMsgs_Call) RunAndReturn(run func(context.Context, []types.Msg, ...v1beta4.BroadcastOption) (interface{}, error)) *TxClient_BroadcastMsgs_Call {
	_c.Call.Return(run)
	return _c
}

// BroadcastTx provides a mock function with given fields: _a0, _a1, _a2
func (_m *TxClient) BroadcastTx(_a0 context.Context, _a1 types.Tx, _a2 ...v1beta4.BroadcastOption) (interface{}, error) {
	_va := make([]interface{}, len(_a2))
	for _i := range _a2 {
		_va[_i] = _a2[_i]
	}
	...
	var r0 interface{}
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, types.Tx, ...v1beta4.BroadcastOption) (interface{}, error)); ok {
		return rf(_a0, _a1, _a2...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, types.Tx, ...v1beta4.BroadcastOption) interface{}); ok {
		r0 = rf(_a0, _a1, _a2...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(interface{})
	...
	if rf, ok := ret.Get(1).(func(context.Context, types.Tx, ...v1beta4.BroadcastOption) error); ok {
		r1 = rf(_a0, _a1, _a2...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *TxClient_BroadcastTx_Call) Run(run func(_a0 context.Context, _a1 types.Tx, _a2 ...v1beta4.BroadcastOption)) *TxClient_BroadcastTx_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]v1beta4.BroadcastOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *TxClient_BroadcastTx_Call) RunAndReturn(run func(context.Context, types.Tx, ...v1beta4.BroadcastOption) (interface{}, error)) *TxClient_BroadcastTx_Call {
	_c.Call.Return(run)
	return _c
}
