...
// BME provides a mock function with no fields
func (_m *QueryClient) BME() bmev1.QueryClient {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for BME")
	}

	var r0 bmev1.QueryClient
	if rf, ok := ret.Get(0).(func() bmev1.QueryClient); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(bmev1.QueryClient)
		}
	}
...
// QueryClient_BME_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'BME'
type QueryClient_BME_Call struct {
	*mock.Call
}

// BME is a helper method to define mock.On call
func (_e *QueryClient_Expecter) BME() *QueryClient_BME_Call {
	return &QueryClient_BME_Call{Call: _e.mock.On("BME")}
}

func (_c *QueryClient_BME_Call) Run(run func()) *QueryClient_BME_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *QueryClient_BME_Call) Return(_a0 bmev1.QueryClient) *QueryClient_BME_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *QueryClient_BME_Call) RunAndReturn(run func() bmev1.QueryClient) *QueryClient_BME_Call {
	_c.Call.Return(run)
	return _c
}
...
// QueryClient_Oracle_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Oracle'
type QueryClient_Oracle_Call struct {
	*mock.Call
}

// Oracle is a helper method to define mock.On call
func (_e *QueryClient_Expecter) Oracle() *QueryClient_Oracle_Call {
	return &QueryClient_Oracle_Call{Call: _e.mock.On("Oracle")}
}

func (_c *QueryClient_Oracle_Call) Run(run func()) *QueryClient_Oracle_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_m *QueryClient) Wasm() wasmtypes.QueryClient {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for Wasm")
	}

	var r0 wasmtypes.QueryClient
	if rf, ok := ret.Get(0).(func() wasmtypes.QueryClient); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(wasmtypes.QueryClient)
		}
	}
...
// QueryClient_Wasm_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Wasm'
type QueryClient_Wasm_Call struct {
	*mock.Call
}

// Wasm is a helper method to define mock.On call
func (_e *QueryClient_Expecter) Wasm() *QueryClient_Wasm_Call {
	return &QueryClient_Wasm_Call{Call: _e.mock.On("Wasm")}
}

func (_c *QueryClient_Wasm_Call) Run(run func()) *QueryClient_Wasm_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *QueryClient_Wasm_Call) Return(_a0 wasmtypes.QueryClient) *QueryClient_Wasm_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *QueryClient_Wasm_Call) RunAndReturn(run func() wasmtypes.QueryClient) *QueryClient_Wasm_Call {
	_c.Call.Return(run)
	return _c
}
