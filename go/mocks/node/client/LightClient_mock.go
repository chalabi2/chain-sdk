...
func (_m *LightClient) Node() v1beta4.NodeClient {
	ret := _m.Called()
...
func (_c *LightClient_Node_Call) Return(_a0 v1beta4.NodeClient) *LightClient_Node_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *LightClient_Node_Call) RunAndReturn(run func() v1beta4.NodeClient) *LightClient_Node_Call {
	_c.Call.Return(run)
	return _c
}

// PrintJSON provides a mock function with given fields: msg
func (_m *LightClient) PrintJSON(msg interface{}) error {
	ret := _m.Called(msg)
...
// LightClient_PrintJSON_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PrintJSON'
type LightClient_PrintJSON_Call struct {
	*mock.Call
}

// PrintJSON is a helper method to define mock.On call
//   - msg interface{}
func (_e *LightClient_Expecter) PrintJSON(msg interface{}) *LightClient_PrintJSON_Call {
	return &LightClient_PrintJSON_Call{Call: _e.mock.On("PrintJSON", msg)}
}

func (_c *LightClient_PrintJSON_Call) Run(run func(msg interface{})) *LightClient_PrintJSON_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *LightClient_PrintJSON_Call) Return(_a0 error) *LightClient_PrintJSON_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *LightClient_PrintJSON_Call) RunAndReturn(run func(interface{}) error) *LightClient_PrintJSON_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *LightClient) Query() v1beta4.QueryClient {
	ret := _m.Called()
...
func (_c *LightClient_Query_Call) Return(_a0 v1beta4.QueryClient) *LightClient_Query_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *LightClient_Query_Call) RunAndReturn(run func() v1beta4.QueryClient) *LightClient_Query_Call {
	_c.Call.Return(run)
	return _c
}
